...
This presentation will use the R programming language and assume the user is using Rstudio to compile their R markdown files into HTML [@Rlang2019; @Rstudio].  If you want to follow along with the R markdown, it can be downloaded <a href="https://waderstats.com/rstudio-files/creating_an_analytic_data_set/creating_an_analytic_data_set.Rmd" target="_blank">here</a>.  The associated bibliography file is <a href="https://waderstats.com/rstudio-files/creating_an_analytic_data_set/creating_an_analytic_data_set.bib" target="_blank">here</a>.
